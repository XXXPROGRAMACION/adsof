...
public class BasicCell implements IMatrixElement<List<IBasicAgent>> {
    private List<IBasicAgent> agents;
    private int i;
    private int j;

    public BasicCell(int i, int j) {
        this.i = i;
        this.j = j;
    ...
    public boolean equals(Object obj) {
       if (!(obj instanceof BasicCell)) return false;
       BasicCell c = (BasicCell) obj;
