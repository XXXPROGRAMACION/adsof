...
public class Apartado6 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("El valor de la propiedad del agente A es " + agentA.get("Propiedad"));
        System.out.println("El valor de la propiedad del agente B es " + agentB.get("Propiedad"));
        System.out.println("El valor de la propiedad del agente C es " + agentC.get("Propiedad"));
    }
}